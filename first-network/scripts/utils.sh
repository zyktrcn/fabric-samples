...
setGlobals() {
  ...
  if [ $ORG -eq 1 ]; then
    ...
    if [ $PEER -eq 0 ]; then
      CORE_PEER_ADDRESS=peer0.org2.example.com:15051
    elif [ $PEER -eq 1 ]; then
      CORE_PEER_ADDRESS=peer1.org2.example.com:16051
    elif [ $PEER -eq 2 ]; then
      CORE_PEER_ADDRESS=peer2.org2.example.com:17051
    elif [ $PEER -eq 3 ]; then
      CORE_PEER_ADDRESS=peer3.org2.example.com:18051
    elif [ $PEER -eq 4 ]; then
      CORE_PEER_ADDRESS=peer4.org2.example.com:19051
    elif [ $PEER -eq 5 ]; then
      CORE_PEER_ADDRESS=peer5.org2.example.com:20051
    elif [ $PEER -eq 6 ]; then
      CORE_PEER_ADDRESS=peer6.org2.example.com:21051
    else
      CORE_PEER_ADDRESS=peer7.org2.example.com:22051
    fi
